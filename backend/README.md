...
## Project Structure
    ...
    ├── wandering_recipe_de_87878  # Django project configurations
...
1. Clone this repo and `cd wandering_recipe_de_87878`
...
2. Clone this repo and `cd wandering_recipe_de_87878`
